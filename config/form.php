<?php return array(
	...
	// Whether Form should fetch errors from Session
	'fetch_errors'            => true,

	// Whether Form should try to apply Validator rules as attributes
	'live_validation'         => true,

	// Whether Form should automatically fetch error messages and
	...
	// Where Form should look for translations
	...
	// The framework to be used by Form
	'framework'               => 'TwitterBootstrap3',

	'TwitterBootstrap3'       => array(

		// Map Form-supported viewports to Bootstrap 3 equivalents
		'viewports'   => array(
			'large'  => 'lg',
			'medium' => 'md',
			'small'  => 'sm',
	...
	'ZurbFoundation5'         => array(
		// Map Form-supported viewports to Foundation 5 equivalents
		'viewports'           => array(
			'large'  => 'large',
			'medium' => null,
			'small'  => 'small',
