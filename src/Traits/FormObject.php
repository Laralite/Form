...
/**
 * Base Form object that allows chained attributes setting, adding
 * classes to the existing ones, and provide types helpers
 */
abstract class FormObject extends Element
{
	/**
	 * The field's name
	 *
