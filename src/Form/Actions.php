 ...
 */
class Actions extends FormObject
{
	/**
	 * The Container
	 *
	...
	public function __construct(Container $app, $value)
	{
		...
		$this->addClass($this->app['form.framework']->getActionClasses());
	}
	...
	public function getContent()
	{
		...
		return $this->app['form.framework']->wrapActions(implode(' ', $content));
	}
	...
	{
		$this->value[] = $this->app['form']->$type($name, $link, $attributes)->__toString();
