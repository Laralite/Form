...
/**
 * Various helpers used by all Form classes
 */
class Helpers
{
	/**
	...
	public static function translate($key, $fallback = null)
	{
		...
		$translation   = null;
		$translateFrom = static::$app['form']->getOption('translate_from');
		...
		// Capitalize
		$capitalize = static::$app['form']->getOption('capitalize_translations');
