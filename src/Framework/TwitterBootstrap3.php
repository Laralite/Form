<?php
namespace Laralite\Form\Framework;

use Laralite\Form\Interfaces\FrameworkInterface;
use Laralite\Form\Traits\Field;
use Laralite\Form\Traits\Framework;
...
class TwitterBootstrap3 extends Framework implements FrameworkInterface
{
	 ...
	 * See Form docs to use 'social' and 'filetypes' sets for specific icons.
	 *
	 * @var string
	 */
	...
	public function getLabelClasses()
	{
		...
		} elseif ($this->app['form.form']->isOfType('inline')) {
	...
	{
		if ($this->app['form.form']->isOfType('horizontal') || $this->app['form.form']->isOfType('inline')) {
			return 'form-group';
		}
